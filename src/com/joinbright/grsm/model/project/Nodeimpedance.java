...
/**
 * Nodeimpedance entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class Nodeimpedance extends com.joinbright.grsm.model.BaseModel
    ...
    public Nodeimpedance(Integer index1, String runway, String substation,
            String branchid, Short prolocation, String busid,
            String overhaulbranchid, String calculationtype, Float impedance1R,
            Float impedance1I, Float impedance2R, Float impedance2I,
            Float impedance0R, Float impedance0I, Float impedance1RPu,
            Float impedance1IPu, Float impedance2RPu, Float impedance2IPu,
            Float impedance0RPu, Float impedance0IPu) {
        super();
        this.index1 = index1;
        this.runway = runway;
        this.substation = substation;
